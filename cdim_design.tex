...
Passive thermal regulation is maintained using a V-groove radiator, which bounces radiative heat into the \SI{3}{\kelvin} background of space~\cite{bard_1987}.
...
Based on a rough power budget and the spacecraft's position at L$_2$, {\color{red}the array must be $x$\si{\meter\squared}} in area to sustain operation.
...
The CDIM spacecraft bus will not feature novel technology, and will leverage high technology-readiness-level (TRL) or off-the-shelf components.

% \section{Mission Profile}
% \label{sec:mission-profile}
\section{Launch Vehicle}
\label{subsec:launch}
CDIM will be comfortably within the mass and spatial limits of both currently available and development launch vehicles capable of delivering payloads to Sun-Earth Lagrange Point L$_2$.
{\color{red}Launch vehicles currently in development are more than capable of delivering CDIM to L$_2$, and industry trends indicate that heavy and super-heavy vehicles will continue to come online by the time CDIM launches.}
...
Multiple methods are used to develop a reasonable cost model for CDIM.\@
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figs/ota_cost-diameter_stahl2010.png}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figs/total-cost-vs-diameter.png}
