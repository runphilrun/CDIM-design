...
The primary mirror is notionally assumed to be constructed from light-weighted ultra-low expansion silica-titania glass with a honeycomb core and a gold-deposition surface coating.
...
% \red{Preliminary heat transfer calculations estimate a capacity of \SI{0}{\watt} from a \SI{0}{\meter\squared} 3-stage v-groove radiator.}
...
\begin{align}
  ...
  &A_{sa} = \frac{P_{sa}}{P_{EOL}} = \frac{\SI{2400}{\watt}}{\SI{233.6}{\watt\per\meter\squared}} = \SI{10.27}{\meter\squared} \label{eq:array-area}
\end{align}
