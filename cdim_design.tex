...
To be conservative, the solar flux at \Ltwo, $P_{sol}$, is estimated to be \SI{1200}{\watt}~\cite{evans2002natural}.
\SI{2000}{\watt} is the assumed power draw from all CDIM instruments and components, $P_{sc}$.
Other margins and efficiencies are listed in~\autoref{tab:solar-array}.

\begin{table}
  \caption{Margins and efficiencies of triple junction Gallium Arsenide solar cells.
...
The end-of-life performance of solar cells is found from the general relationship in~\autoref{eq:p-eol}, with respect to mission duration, $L$, and estimated efficiency degradation, $D$~\cite{smad2015}.
