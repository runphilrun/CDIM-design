...
\begin{figure}[!hb]
  ...
  \caption{Low emmissivity, high specular surface vanes arenested at a slight angle to reflect thermal radiation into space~\cite{rasbach1988}. \red{Replace this figure with a powerpoint graphic.}}
\label{fig:v-groove}
\end{figure}
