...
\red{Derive context for the case for CDIM from CDIM 2 page~\cite{cooray2016cdim2page}.}
...
CDIM is optimized to search for the first cosmic sources of dust and evidence of the very earliest stellar populations, bridging the gaps in the JWST and WFIRST cosmic dawn surveys and exceeding them in capability. Critical design requirements are summarized in~\autoref{tab:critical-params}.
